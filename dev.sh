...
touch "$BASE_DIR/.logs/rag-api.log" "$BASE_DIR/.logs/orchestrator-api.log" "$BASE_DIR/.logs/rag-worker.log" "$BASE_DIR/.logs/community-worker.log" "$BASE_DIR/.logs/audit-api.log"
tail -f "$BASE_DIR/.logs/rag-api.log" "$BASE_DIR/.logs/orchestrator-api.log" "$BASE_DIR/.logs/rag-worker.log" "$BASE_DIR/.logs/community-worker.log" "$BASE_DIR/.logs/audit-api.log"
