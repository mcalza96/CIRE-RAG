...
from orchestrator.runtime.qa_orchestrator.adapters import (
    GroqAnswerGeneratorAdapter,
    LiteralEvidenceValidator,
    RetrievalToolsAdapter,
)
from orchestrator.runtime.qa_orchestrator.models import (
    AnswerDraft,
...
class HandleQuestionUseCase:
    ...
    def __init__(
        ...
        answer_generator: GroqAnswerGeneratorAdapter,
