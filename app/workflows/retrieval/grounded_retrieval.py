...
class GroundedRetrievalWorkflow:
    """
    Workflow for Grounded Knowledge Retrieval.
    Orchestrates scope resolution, routing, and security validation.
    Formerly part of GroundedRetrievalWorkflow.
    """
    ...
    async def get_grounded_context(
        ...
        """
        Executes the grounded retrieval workflow.
        """
